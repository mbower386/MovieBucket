app.controller("userController", function ($scope, $state, $stateParams, userService, movieService) {
  ...
  $scope.randomMovie = function () {
    movieService.randomMovie();
  }

  // Destroy a user's movie
  $scope.removeMovieFromUser = function (movie) {
    userService.removeMovieFromUser(movie);
  }

  // View a user's movie
  $scope.viewUserMovie = function (movie) {
    console.log(movie);
